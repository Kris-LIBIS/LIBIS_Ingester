...
require "libis/ingester/teneo/defaults"
...
class Pip 
  ...
  xml_name "ns1:pip"
          ...
          xml_accessor :config, :as => Libis::Ingester::Teneo::Config, :from => "ns1:config", :required => false
          xml_accessor :defaults, :as => Libis::Ingester::Teneo::Defaults, :from => "ns1:defaults", :required => false
